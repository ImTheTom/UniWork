...
#-------Function for pieces------------------------------------------#
#Creating a function to draw Piece A
from turtle import *
def pieceA():
    #pre drawing components
    pencolor('black')
    penup()
    pendown()
    pensize(1)
    ...
    begin_fill
    fillcolor('red')
    #inside conponents of the actual picture in the top left position
    forward(60)
    pensize(5)
    left(90)
    forward(60)
...
#Creating a function to draw Piece B
def pieceB():
    #pre drawing parts
    pencolor('black')
    pendown()
    ...
    forward(125)
    end_fill()
    #inside conponents of the top right part of the picture
    penup()
    pensize(5)
    setheading(0)
    forward(240)
...
#creating a function to draw piece C
def pieceC():
    #pre drawing components
    pencolor('black')
    setheading(0)
    ...
    forward(300)
    end_fill()
    #inside components of the bottom left picture
    setheading(90)
    forward(300)
    right(90)
    forward(60)
...
#creating a function to draw piece D
def pieceD():
    #Pre drawing components
    pencolor('black')
    setheading(0)
    ...
    forward(125)
    end_fill()
    #inside components of the picture in the bottom right
    penup()
    setheading(90)
    forward(300)
    right(90)
...
#creating a imagine to display missing piece of a picture
def misssing():
#drawing the picture frame
    ...
    setheading(315)
    forward(25)
    #drawing crack in picture frame
    setheading(185)
    forward(10)
    setheading(270)
    forward(5)
...
#
# creating functions that will help make the draw_attempt function more clean
def first(attempt_number):
    attempt=attempt_number[0]
    if len(attempt)==2:
        if attempt[1] == 'In box':
            x=250,-100
            goto(x)
        elif attempt[1] == 'Top left':
            x=-600, 0
            goto(x)
        elif attempt[1] == 'Top right':
            x=-300,0
            goto(x)
        elif attempt[1] == 'Bottom left':
            x=-600, -300
            goto(x)
        elif attempt[1] == 'Bottom right':
            x=-300, -300
            goto(x)
        if attempt[0] == 'Piece A':
            pieceA()
        elif attempt[0] == 'Piece B':
            pieceB()
        elif attempt[0] == 'Piece C':
            pieceC()
        elif attempt[0] == 'Piece D':
            pieceD()
    elif len(attempt)==3:
        if attempt[1] == 'In box':
            x=250,-100
...
def second(attempt_number):
    attempt2=attempt_number[1]
    if len(attempt2) == 2:
        if attempt2[1] == 'In box':
            x=250,-100
            goto(x)
        elif attempt2[1] == 'Top left':
            x=-600, 0
            goto(x)
        elif attempt2[1] == 'Top right':
            x=-300,0
            goto(x)
        elif attempt2[1] == 'Bottom left':
            x=-600, -300
            goto(x)
        elif attempt2[1] == 'Bottom right':
            x=-300, -300
            goto(x)
        if attempt2[0] == 'Piece A':
            pieceA()
        elif attempt2[0] == 'Piece B':
            pieceB()
        elif attempt2[0] == 'Piece C':
            pieceC()
        elif attempt2[0] == 'Piece D':
            pieceD()
    elif len(attempt2)==3:
        if attempt2[1] == 'In box':
            x=250,-100
...
def third(attempt_number):
    attempt3=attempt_number[2]
    if len(attempt3)==2:
        if attempt3[1] == 'In box':
            x=250,-100
            goto(x)
        elif attempt3[1] == 'Top left':
            x=-600, 0
            goto(x)
        elif attempt3[1] == 'Top right':
            x=-300,0
            goto(x)
        elif attempt3[1] == 'Bottom left':
            x=-600, -300
            goto(x)
        elif attempt3[1] == 'Bottom right':
            x=-300, -300
            goto(x)
        if attempt3[0] == 'Piece A':
            pieceA()
        elif attempt3[0] == 'Piece B':
            pieceB()
        elif attempt3[0] == 'Piece C':
            pieceC()
        elif attempt3[0] == 'Piece D':
            pieceD()
    elif len(attempt3)==3:
        if attempt3[1] == 'In box':
            x=250,-100
...
def forth(attempt_number):
    attempt4=attempt_number[3]
    if len(attempt4)==2:
        if attempt4[1] == 'In box':
            x=250,-100
            goto(x)
        elif attempt4[1] == 'Top left':
            x=-600, 0
            goto(x)
        elif attempt4[1] == 'Top right':
            x=-300,0
            goto(x)
        elif attempt4[1] == 'Bottom left':
            x=-600, -300
            goto(x)
        elif attempt4[1] == 'Bottom right':
            x=-300, -300
            goto(x)
        if attempt4[0] == 'Piece A':
            pieceA()
        elif attempt4[0] == 'Piece B':
            pieceB()
        elif attempt4[0] == 'Piece C':
            pieceC()
        elif attempt4[0] == 'Piece D':
            pieceD()
    elif len(attempt4)==3:
        if attempt4[1] == 'In box':
            x=250,-100
...
#creating the draw_attempt function

def draw_attempt(attempt_number):
    if len(attempt_number)==1:
        first(attempt_number)
    elif len(attempt_number)==2:
        first(attempt_number)
        second(attempt_number)
    elif len(attempt_number)==3:
        first(attempt_number)
        second(attempt_number)
        third(attempt_number)
    elif len(attempt_number)==4:
        first(attempt_number)
        second(attempt_number)
        third(attempt_number)
        forth(attempt_number)
